...
import { Fingerprint, Lock, Terminal, Zap, ArrowRight, UserCircle, AlertTriangle } from 'lucide-react';
          ...
          <div className="p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2 relative">
                <label className="text-[9px] font-bold text-slate-400 tracking-[0.2em] uppercase ml-1">Alias / Uplink</label>
              ...
              <div className="flex flex-col gap-2 relative">
                <label className="text-[9px] font-bold text-slate-400 tracking-[0.2em] uppercase ml-1">Decryption Key</label>
                <div className="flex h-14 bg-[#050A11] border border-slate-800 rounded-lg overflow-hidden focus-within:border-cyan-500/50 focus-within:shadow-[0_0_15px_rgba(34,211,238,0.15)] transition-all">
                  <div className="w-12 flex items-center justify-center bg-[#0a0f18] border-r border-slate-800 text-slate-500">
